...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        unique=True,
        help_text="Enter a genre (e.g. Science Fiction, French Poetry etc.)"
    )
...
class Book(models.Model):
    ...
    language = models.ForeignKey('Language', on_delete=models.RESTRICT,
                                 null=True)  # Allow null values for previous books
    ...
    def display_genre(self):
        """Create a string for the Genre. This is required to
...
class Language(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        unique=True,
        help_text="Enter a language (e.g. Spanish, French etc.)"
    )
    ...
    class Meta:
        constraints = [
            UniqueConstraint(
                ...
                violation_error_message="Language already "
